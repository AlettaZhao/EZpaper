...
TOPIC_TAG_RULES = [
    ...
    ("XR", ["extended reality", "xr", "virtual reality", "vr", "augmented reality", "ar navigation", "mobile ar", "ar headset", "ar glasses", "ar display", "ar interface", "ar application", "mixed reality", "spatial computing", "head-mounted", "hmd"]),
